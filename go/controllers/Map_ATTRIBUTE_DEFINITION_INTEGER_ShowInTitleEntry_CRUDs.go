...
func (controller *Controller) UpdateMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTitleEntry(c *gin.Context) {
	...
	if map_attribute_definition_integer_showintitleentryOld != nil {
		if !hasMouseEvent {
			models.OnAfterUpdateFromFront(backRepo.GetStage(), map_attribute_definition_integer_showintitleentryOld, map_attribute_definition_integer_showintitleentryNew, nil)
		} else {
			mouseEvent := &models.Gong__MouseEvent{
				ShiftKey: shiftKey,
			}
			models.OnAfterUpdateFromFront(backRepo.GetStage(), map_attribute_definition_integer_showintitleentryOld, map_attribute_definition_integer_showintitleentryNew, mouseEvent)
