...
func (controller *Controller) PostXhtml_p_type(c *gin.Context) {
	...
	query := db.Create(&xhtml_p_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) GetXhtml_p_type(c *gin.Context) {
	...
	if err := db.First(&xhtml_p_typeDB, c.Param("id")).Error; err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
...
func (controller *Controller) UpdateXhtml_p_type(c *gin.Context) {
	...
	query := db.First(&xhtml_p_typeDB, c.Param("id"))
	...
	query = db.Model(&xhtml_p_typeDB).Updates(xhtml_p_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) DeleteXhtml_p_type(c *gin.Context) {
	...
	db.Unscoped().Delete(&xhtml_p_typeDB)
