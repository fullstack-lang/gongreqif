...
func (controller *Controller) GetSPEC_OBJECT_TYPEs(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSPEC_OBJECT_TYPEs", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostSPEC_OBJECT_TYPE(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostSPEC_OBJECT_TYPEs", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetSPEC_OBJECT_TYPE(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSPEC_OBJECT_TYPE", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateSPEC_OBJECT_TYPE(c *gin.Context) {
	...
	if spec_object_typeOld != nil {
		if !hasMouseEvent {
			models.OnAfterUpdateFromFront(backRepo.GetStage(), spec_object_typeOld, spec_object_typeNew, nil)
		} else {
			mouseEvent := &models.Gong__MouseEvent{
				ShiftKey: shiftKey,
			}
			models.OnAfterUpdateFromFront(backRepo.GetStage(), spec_object_typeOld, spec_object_typeNew, mouseEvent)
...
func (controller *Controller) DeleteSPEC_OBJECT_TYPE(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteSPEC_OBJECT_TYPE", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
