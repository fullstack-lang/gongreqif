...
import (
	...
	gongreqif_orm "github.com/fullstack-lang/gongreqif/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*gongreqif_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*gongreqif_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gongreqif_orm.BackRepoStruct, stackPath string) {
