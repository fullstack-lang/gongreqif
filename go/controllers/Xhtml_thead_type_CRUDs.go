...
func (controller *Controller) GetXhtml_thead_types(c *gin.Context) {
	...
	query := db.Find(&xhtml_thead_typeDBs)
	if query.Error != nil {
...
func (controller *Controller) PostXhtml_thead_type(c *gin.Context) {
	...
	query := db.Create(&xhtml_thead_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) GetXhtml_thead_type(c *gin.Context) {
	...
	if err := db.First(&xhtml_thead_typeDB, c.Param("id")).Error; err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
...
func (controller *Controller) UpdateXhtml_thead_type(c *gin.Context) {
	...
	query := db.First(&xhtml_thead_typeDB, c.Param("id"))
	...
	query = db.Model(&xhtml_thead_typeDB).Updates(xhtml_thead_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) DeleteXhtml_thead_type(c *gin.Context) {
	...
	db.Unscoped().Delete(&xhtml_thead_typeDB)
