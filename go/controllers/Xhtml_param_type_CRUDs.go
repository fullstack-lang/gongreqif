...
func (controller *Controller) GetXhtml_param_types(c *gin.Context) {
	...
	query := db.Find(&xhtml_param_typeDBs)
	if query.Error != nil {
...
func (controller *Controller) PostXhtml_param_type(c *gin.Context) {
	...
	query := db.Create(&xhtml_param_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) GetXhtml_param_type(c *gin.Context) {
	...
	if err := db.First(&xhtml_param_typeDB, c.Param("id")).Error; err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
...
func (controller *Controller) UpdateXhtml_param_type(c *gin.Context) {
	...
	query := db.First(&xhtml_param_typeDB, c.Param("id"))
	...
	query = db.Model(&xhtml_param_typeDB).Updates(xhtml_param_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) DeleteXhtml_param_type(c *gin.Context) {
	...
	db.Unscoped().Delete(&xhtml_param_typeDB)
