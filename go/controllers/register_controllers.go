...
func registerControllers(r *gin.Engine) {
	...
	{ // insertion point for registrations
		...
		v1.PATCH("/v1/map_attribute_definition_boolean_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInSubjectEntry)
		v1.PUT("/v1/map_attribute_definition_boolean_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInSubjectEntry)
		v1.DELETE("/v1/map_attribute_definition_boolean_showinsubjectentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInSubjectEntry)

		v1.GET("/v1/map_attribute_definition_boolean_showintableentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTableEntrys)
		v1.GET("/v1/map_attribute_definition_boolean_showintableentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTableEntry)
		v1.POST("/v1/map_attribute_definition_boolean_showintableentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTableEntry)
		v1.PATCH("/v1/map_attribute_definition_boolean_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTableEntry)
		v1.PUT("/v1/map_attribute_definition_boolean_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTableEntry)
		v1.DELETE("/v1/map_attribute_definition_boolean_showintableentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTableEntry)

		v1.GET("/v1/map_attribute_definition_boolean_showintitleentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTitleEntrys)
		v1.GET("/v1/map_attribute_definition_boolean_showintitleentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTitleEntry)
		v1.POST("/v1/map_attribute_definition_boolean_showintitleentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTitleEntry)
		v1.PATCH("/v1/map_attribute_definition_boolean_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTitleEntry)
		v1.PUT("/v1/map_attribute_definition_boolean_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTitleEntry)
		v1.DELETE("/v1/map_attribute_definition_boolean_showintitleentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_BOOLEAN_ShowInTitleEntry)

		v1.GET("/v1/map_attribute_definition_date_showinsubjectentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_DATE_ShowInSubjectEntrys)
		v1.GET("/v1/map_attribute_definition_date_showinsubjectentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_DATE_ShowInSubjectEntry)
		v1.POST("/v1/map_attribute_definition_date_showinsubjectentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_DATE_ShowInSubjectEntry)
		v1.PATCH("/v1/map_attribute_definition_date_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_DATE_ShowInSubjectEntry)
		v1.PUT("/v1/map_attribute_definition_date_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_DATE_ShowInSubjectEntry)
		v1.DELETE("/v1/map_attribute_definition_date_showinsubjectentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_DATE_ShowInSubjectEntry)

		v1.GET("/v1/map_attribute_definition_date_showintableentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_DATE_ShowInTableEntrys)
		v1.GET("/v1/map_attribute_definition_date_showintableentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_DATE_ShowInTableEntry)
		v1.POST("/v1/map_attribute_definition_date_showintableentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_DATE_ShowInTableEntry)
		v1.PATCH("/v1/map_attribute_definition_date_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_DATE_ShowInTableEntry)
		v1.PUT("/v1/map_attribute_definition_date_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_DATE_ShowInTableEntry)
		v1.DELETE("/v1/map_attribute_definition_date_showintableentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_DATE_ShowInTableEntry)

		v1.GET("/v1/map_attribute_definition_date_showintitleentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_DATE_ShowInTitleEntrys)
		v1.GET("/v1/map_attribute_definition_date_showintitleentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_DATE_ShowInTitleEntry)
		v1.POST("/v1/map_attribute_definition_date_showintitleentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_DATE_ShowInTitleEntry)
		v1.PATCH("/v1/map_attribute_definition_date_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_DATE_ShowInTitleEntry)
		v1.PUT("/v1/map_attribute_definition_date_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_DATE_ShowInTitleEntry)
		v1.DELETE("/v1/map_attribute_definition_date_showintitleentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_DATE_ShowInTitleEntry)

		v1.GET("/v1/map_attribute_definition_enumeration_showinsubjectentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInSubjectEntrys)
		v1.GET("/v1/map_attribute_definition_enumeration_showinsubjectentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInSubjectEntry)
		v1.POST("/v1/map_attribute_definition_enumeration_showinsubjectentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInSubjectEntry)
		v1.PATCH("/v1/map_attribute_definition_enumeration_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInSubjectEntry)
		v1.PUT("/v1/map_attribute_definition_enumeration_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInSubjectEntry)
		v1.DELETE("/v1/map_attribute_definition_enumeration_showinsubjectentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInSubjectEntry)

		v1.GET("/v1/map_attribute_definition_enumeration_showintableentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTableEntrys)
		v1.GET("/v1/map_attribute_definition_enumeration_showintableentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTableEntry)
		v1.POST("/v1/map_attribute_definition_enumeration_showintableentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTableEntry)
		v1.PATCH("/v1/map_attribute_definition_enumeration_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTableEntry)
		v1.PUT("/v1/map_attribute_definition_enumeration_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTableEntry)
		v1.DELETE("/v1/map_attribute_definition_enumeration_showintableentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTableEntry)

		v1.GET("/v1/map_attribute_definition_enumeration_showintitleentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTitleEntrys)
		v1.GET("/v1/map_attribute_definition_enumeration_showintitleentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTitleEntry)
		v1.POST("/v1/map_attribute_definition_enumeration_showintitleentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTitleEntry)
		v1.PATCH("/v1/map_attribute_definition_enumeration_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTitleEntry)
		v1.PUT("/v1/map_attribute_definition_enumeration_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTitleEntry)
		v1.DELETE("/v1/map_attribute_definition_enumeration_showintitleentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_ENUMERATION_ShowInTitleEntry)

		v1.GET("/v1/map_attribute_definition_integer_showinsubjectentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInSubjectEntrys)
		v1.GET("/v1/map_attribute_definition_integer_showinsubjectentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInSubjectEntry)
		v1.POST("/v1/map_attribute_definition_integer_showinsubjectentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInSubjectEntry)
		v1.PATCH("/v1/map_attribute_definition_integer_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInSubjectEntry)
		v1.PUT("/v1/map_attribute_definition_integer_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInSubjectEntry)
		v1.DELETE("/v1/map_attribute_definition_integer_showinsubjectentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInSubjectEntry)

		v1.GET("/v1/map_attribute_definition_integer_showintableentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTableEntrys)
		v1.GET("/v1/map_attribute_definition_integer_showintableentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTableEntry)
		v1.POST("/v1/map_attribute_definition_integer_showintableentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTableEntry)
		v1.PATCH("/v1/map_attribute_definition_integer_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTableEntry)
		v1.PUT("/v1/map_attribute_definition_integer_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTableEntry)
		v1.DELETE("/v1/map_attribute_definition_integer_showintableentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTableEntry)

		v1.GET("/v1/map_attribute_definition_integer_showintitleentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTitleEntrys)
		v1.GET("/v1/map_attribute_definition_integer_showintitleentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTitleEntry)
		v1.POST("/v1/map_attribute_definition_integer_showintitleentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTitleEntry)
		v1.PATCH("/v1/map_attribute_definition_integer_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTitleEntry)
		v1.PUT("/v1/map_attribute_definition_integer_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTitleEntry)
		v1.DELETE("/v1/map_attribute_definition_integer_showintitleentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_INTEGER_ShowInTitleEntry)

		v1.GET("/v1/map_attribute_definition_real_showinsubjectentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_REAL_ShowInSubjectEntrys)
		v1.GET("/v1/map_attribute_definition_real_showinsubjectentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_REAL_ShowInSubjectEntry)
		v1.POST("/v1/map_attribute_definition_real_showinsubjectentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_REAL_ShowInSubjectEntry)
		v1.PATCH("/v1/map_attribute_definition_real_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_REAL_ShowInSubjectEntry)
		v1.PUT("/v1/map_attribute_definition_real_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_REAL_ShowInSubjectEntry)
		v1.DELETE("/v1/map_attribute_definition_real_showinsubjectentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_REAL_ShowInSubjectEntry)

		v1.GET("/v1/map_attribute_definition_real_showintableentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_REAL_ShowInTableEntrys)
		v1.GET("/v1/map_attribute_definition_real_showintableentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_REAL_ShowInTableEntry)
		v1.POST("/v1/map_attribute_definition_real_showintableentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_REAL_ShowInTableEntry)
		v1.PATCH("/v1/map_attribute_definition_real_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_REAL_ShowInTableEntry)
		v1.PUT("/v1/map_attribute_definition_real_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_REAL_ShowInTableEntry)
		v1.DELETE("/v1/map_attribute_definition_real_showintableentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_REAL_ShowInTableEntry)

		v1.GET("/v1/map_attribute_definition_real_showintitleentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_REAL_ShowInTitleEntrys)
		v1.GET("/v1/map_attribute_definition_real_showintitleentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_REAL_ShowInTitleEntry)
		v1.POST("/v1/map_attribute_definition_real_showintitleentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_REAL_ShowInTitleEntry)
		v1.PATCH("/v1/map_attribute_definition_real_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_REAL_ShowInTitleEntry)
		v1.PUT("/v1/map_attribute_definition_real_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_REAL_ShowInTitleEntry)
		v1.DELETE("/v1/map_attribute_definition_real_showintitleentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_REAL_ShowInTitleEntry)

		v1.GET("/v1/map_attribute_definition_string_showinsubjectentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_STRING_ShowInSubjectEntrys)
		v1.GET("/v1/map_attribute_definition_string_showinsubjectentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_STRING_ShowInSubjectEntry)
		v1.POST("/v1/map_attribute_definition_string_showinsubjectentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_STRING_ShowInSubjectEntry)
		v1.PATCH("/v1/map_attribute_definition_string_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_STRING_ShowInSubjectEntry)
		v1.PUT("/v1/map_attribute_definition_string_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_STRING_ShowInSubjectEntry)
		v1.DELETE("/v1/map_attribute_definition_string_showinsubjectentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_STRING_ShowInSubjectEntry)

		v1.GET("/v1/map_attribute_definition_string_showintableentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_STRING_ShowInTableEntrys)
		v1.GET("/v1/map_attribute_definition_string_showintableentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_STRING_ShowInTableEntry)
		v1.POST("/v1/map_attribute_definition_string_showintableentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_STRING_ShowInTableEntry)
		v1.PATCH("/v1/map_attribute_definition_string_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_STRING_ShowInTableEntry)
		v1.PUT("/v1/map_attribute_definition_string_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_STRING_ShowInTableEntry)
		v1.DELETE("/v1/map_attribute_definition_string_showintableentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_STRING_ShowInTableEntry)

		v1.GET("/v1/map_attribute_definition_string_showintitleentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_STRING_ShowInTitleEntrys)
		v1.GET("/v1/map_attribute_definition_string_showintitleentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_STRING_ShowInTitleEntry)
		v1.POST("/v1/map_attribute_definition_string_showintitleentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_STRING_ShowInTitleEntry)
		v1.PATCH("/v1/map_attribute_definition_string_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_STRING_ShowInTitleEntry)
		v1.PUT("/v1/map_attribute_definition_string_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_STRING_ShowInTitleEntry)
		v1.DELETE("/v1/map_attribute_definition_string_showintitleentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_STRING_ShowInTitleEntry)

		v1.GET("/v1/map_attribute_definition_xhtml_showinsubjectentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_XHTML_ShowInSubjectEntrys)
		v1.GET("/v1/map_attribute_definition_xhtml_showinsubjectentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_XHTML_ShowInSubjectEntry)
		v1.POST("/v1/map_attribute_definition_xhtml_showinsubjectentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_XHTML_ShowInSubjectEntry)
		v1.PATCH("/v1/map_attribute_definition_xhtml_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_XHTML_ShowInSubjectEntry)
		v1.PUT("/v1/map_attribute_definition_xhtml_showinsubjectentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_XHTML_ShowInSubjectEntry)
		v1.DELETE("/v1/map_attribute_definition_xhtml_showinsubjectentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_XHTML_ShowInSubjectEntry)

		v1.GET("/v1/map_attribute_definition_xhtml_showintableentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTableEntrys)
		v1.GET("/v1/map_attribute_definition_xhtml_showintableentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTableEntry)
		v1.POST("/v1/map_attribute_definition_xhtml_showintableentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTableEntry)
		v1.PATCH("/v1/map_attribute_definition_xhtml_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTableEntry)
		v1.PUT("/v1/map_attribute_definition_xhtml_showintableentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTableEntry)
		v1.DELETE("/v1/map_attribute_definition_xhtml_showintableentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTableEntry)

		v1.GET("/v1/map_attribute_definition_xhtml_showintitleentrys", GetController().GetMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTitleEntrys)
		v1.GET("/v1/map_attribute_definition_xhtml_showintitleentrys/:id", GetController().GetMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTitleEntry)
		v1.POST("/v1/map_attribute_definition_xhtml_showintitleentrys", GetController().PostMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTitleEntry)
		v1.PATCH("/v1/map_attribute_definition_xhtml_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTitleEntry)
		v1.PUT("/v1/map_attribute_definition_xhtml_showintitleentrys/:id", GetController().UpdateMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTitleEntry)
		v1.DELETE("/v1/map_attribute_definition_xhtml_showintitleentrys/:id", GetController().DeleteMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTitleEntry)

		v1.GET("/v1/map_specification_nodes_expandedentrys", GetController().GetMap_SPECIFICATION_Nodes_expandedEntrys)
		v1.GET("/v1/map_specification_nodes_expandedentrys/:id", GetController().GetMap_SPECIFICATION_Nodes_expandedEntry)
		v1.POST("/v1/map_specification_nodes_expandedentrys", GetController().PostMap_SPECIFICATION_Nodes_expandedEntry)
		v1.PATCH("/v1/map_specification_nodes_expandedentrys/:id", GetController().UpdateMap_SPECIFICATION_Nodes_expandedEntry)
		v1.PUT("/v1/map_specification_nodes_expandedentrys/:id", GetController().UpdateMap_SPECIFICATION_Nodes_expandedEntry)
		v1.DELETE("/v1/map_specification_nodes_expandedentrys/:id", GetController().DeleteMap_SPECIFICATION_Nodes_expandedEntry)

		v1.GET("/v1/map_spec_object_type_isnodeexpandedentrys", GetController().GetMap_SPEC_OBJECT_TYPE_isNodeExpandedEntrys)
		v1.GET("/v1/map_spec_object_type_isnodeexpandedentrys/:id", GetController().GetMap_SPEC_OBJECT_TYPE_isNodeExpandedEntry)
		v1.POST("/v1/map_spec_object_type_isnodeexpandedentrys", GetController().PostMap_SPEC_OBJECT_TYPE_isNodeExpandedEntry)
		v1.PATCH("/v1/map_spec_object_type_isnodeexpandedentrys/:id", GetController().UpdateMap_SPEC_OBJECT_TYPE_isNodeExpandedEntry)
		v1.PUT("/v1/map_spec_object_type_isnodeexpandedentrys/:id", GetController().UpdateMap_SPEC_OBJECT_TYPE_isNodeExpandedEntry)
		v1.DELETE("/v1/map_spec_object_type_isnodeexpandedentrys/:id", GetController().DeleteMap_SPEC_OBJECT_TYPE_isNodeExpandedEntry)

		v1.GET("/v1/map_spec_object_type_showidentifierentrys", GetController().GetMap_SPEC_OBJECT_TYPE_showIdentifierEntrys)
		v1.GET("/v1/map_spec_object_type_showidentifierentrys/:id", GetController().GetMap_SPEC_OBJECT_TYPE_showIdentifierEntry)
		v1.POST("/v1/map_spec_object_type_showidentifierentrys", GetController().PostMap_SPEC_OBJECT_TYPE_showIdentifierEntry)
		v1.PATCH("/v1/map_spec_object_type_showidentifierentrys/:id", GetController().UpdateMap_SPEC_OBJECT_TYPE_showIdentifierEntry)
		v1.PUT("/v1/map_spec_object_type_showidentifierentrys/:id", GetController().UpdateMap_SPEC_OBJECT_TYPE_showIdentifierEntry)
		v1.DELETE("/v1/map_spec_object_type_showidentifierentrys/:id", GetController().DeleteMap_SPEC_OBJECT_TYPE_showIdentifierEntry)

		v1.GET("/v1/map_spec_object_type_shownameentrys", GetController().GetMap_SPEC_OBJECT_TYPE_showNameEntrys)
		v1.GET("/v1/map_spec_object_type_shownameentrys/:id", GetController().GetMap_SPEC_OBJECT_TYPE_showNameEntry)
		v1.POST("/v1/map_spec_object_type_shownameentrys", GetController().PostMap_SPEC_OBJECT_TYPE_showNameEntry)
		v1.PATCH("/v1/map_spec_object_type_shownameentrys/:id", GetController().UpdateMap_SPEC_OBJECT_TYPE_showNameEntry)
		...
		v1.GET("/v1/renderingconfigurations", GetController().GetRenderingConfigurations)
		v1.GET("/v1/renderingconfigurations/:id", GetController().GetRenderingConfiguration)
		v1.POST("/v1/renderingconfigurations", GetController().PostRenderingConfiguration)
		v1.PATCH("/v1/renderingconfigurations/:id", GetController().UpdateRenderingConfiguration)
		v1.PUT("/v1/renderingconfigurations/:id", GetController().UpdateRenderingConfiguration)
		v1.DELETE("/v1/renderingconfigurations/:id", GetController().DeleteRenderingConfiguration)
		...
		v1.GET("/v1/staticwebsitegeneratedimages", GetController().GetStaticWebSiteGeneratedImages)
		v1.GET("/v1/staticwebsitegeneratedimages/:id", GetController().GetStaticWebSiteGeneratedImage)
		v1.POST("/v1/staticwebsitegeneratedimages", GetController().PostStaticWebSiteGeneratedImage)
		v1.PATCH("/v1/staticwebsitegeneratedimages/:id", GetController().UpdateStaticWebSiteGeneratedImage)
		v1.PUT("/v1/staticwebsitegeneratedimages/:id", GetController().UpdateStaticWebSiteGeneratedImage)
		v1.DELETE("/v1/staticwebsitegeneratedimages/:id", GetController().DeleteStaticWebSiteGeneratedImage)

		v1.GET("/v1/staticwebsiteimages", GetController().GetStaticWebSiteImages)
		v1.GET("/v1/staticwebsiteimages/:id", GetController().GetStaticWebSiteImage)
		v1.POST("/v1/staticwebsiteimages", GetController().PostStaticWebSiteImage)
		v1.PATCH("/v1/staticwebsiteimages/:id", GetController().UpdateStaticWebSiteImage)
		v1.PUT("/v1/staticwebsiteimages/:id", GetController().UpdateStaticWebSiteImage)
		v1.DELETE("/v1/staticwebsiteimages/:id", GetController().DeleteStaticWebSiteImage)

		v1.GET("/v1/staticwebsiteparagraphs", GetController().GetStaticWebSiteParagraphs)
		v1.GET("/v1/staticwebsiteparagraphs/:id", GetController().GetStaticWebSiteParagraph)
		v1.POST("/v1/staticwebsiteparagraphs", GetController().PostStaticWebSiteParagraph)
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	if err != nil {
		...
		parts := strings.Split("github.com/fullstack-lang/gongreqif/go", "/") // Assuming goFilePath holds the path
		component := "unknown"
		if len(parts) > 2 {
