...
func (controller *Controller) GetXhtml_var_types(c *gin.Context) {
	...
	query := db.Find(&xhtml_var_typeDBs)
	if query.Error != nil {
...
func (controller *Controller) PostXhtml_var_type(c *gin.Context) {
	...
	query := db.Create(&xhtml_var_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) GetXhtml_var_type(c *gin.Context) {
	...
	if err := db.First(&xhtml_var_typeDB, c.Param("id")).Error; err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
...
func (controller *Controller) UpdateXhtml_var_type(c *gin.Context) {
	...
	query := db.First(&xhtml_var_typeDB, c.Param("id"))
	...
	query = db.Model(&xhtml_var_typeDB).Updates(xhtml_var_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) DeleteXhtml_var_type(c *gin.Context) {
	...
	db.Unscoped().Delete(&xhtml_var_typeDB)
