...
func (controller *Controller) UpdateMap_ATTRIBUTE_DEFINITION_XHTML_ShowInTitleEntry(c *gin.Context) {
	...
	if map_attribute_definition_xhtml_showintitleentryOld != nil {
		if !hasMouseEvent {
			models.OnAfterUpdateFromFront(backRepo.GetStage(), map_attribute_definition_xhtml_showintitleentryOld, map_attribute_definition_xhtml_showintitleentryNew, nil)
		} else {
			mouseEvent := &models.Gong__MouseEvent{
				ShiftKey: shiftKey,
			}
			models.OnAfterUpdateFromFront(backRepo.GetStage(), map_attribute_definition_xhtml_showintitleentryOld, map_attribute_definition_xhtml_showintitleentryNew, mouseEvent)
