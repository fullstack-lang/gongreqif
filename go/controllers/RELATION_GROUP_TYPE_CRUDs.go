...
func (controller *Controller) GetRELATION_GROUP_TYPEs(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetRELATION_GROUP_TYPEs", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostRELATION_GROUP_TYPE(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostRELATION_GROUP_TYPEs", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetRELATION_GROUP_TYPE(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetRELATION_GROUP_TYPE", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateRELATION_GROUP_TYPE(c *gin.Context) {
	...
	if relation_group_typeOld != nil {
		if !hasMouseEvent {
			models.OnAfterUpdateFromFront(backRepo.GetStage(), relation_group_typeOld, relation_group_typeNew, nil)
		} else {
			mouseEvent := &models.Gong__MouseEvent{
				ShiftKey: shiftKey,
			}
			models.OnAfterUpdateFromFront(backRepo.GetStage(), relation_group_typeOld, relation_group_typeNew, mouseEvent)
...
func (controller *Controller) DeleteRELATION_GROUP_TYPE(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteRELATION_GROUP_TYPE", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
