...
func (controller *Controller) GetXhtml_dt_types(c *gin.Context) {
	...
	query := db.Find(&xhtml_dt_typeDBs)
	if query.Error != nil {
...
func (controller *Controller) PostXhtml_dt_type(c *gin.Context) {
	...
	query := db.Create(&xhtml_dt_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) GetXhtml_dt_type(c *gin.Context) {
	...
	if err := db.First(&xhtml_dt_typeDB, c.Param("id")).Error; err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
...
func (controller *Controller) UpdateXhtml_dt_type(c *gin.Context) {
	...
	query := db.First(&xhtml_dt_typeDB, c.Param("id"))
	...
	query = db.Model(&xhtml_dt_typeDB).Updates(xhtml_dt_typeDB)
	if query.Error != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = query.Error.Error()
...
func (controller *Controller) DeleteXhtml_dt_type(c *gin.Context) {
	...
	db.Unscoped().Delete(&xhtml_dt_typeDB)
