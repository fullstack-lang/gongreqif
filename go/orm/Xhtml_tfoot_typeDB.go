...
func (backRepoXhtml_tfoot_type *BackRepoXhtml_tfoot_typeStruct) GetStage() (stage *models.Stage) {
...
func (backRepoXhtml_tfoot_type *BackRepoXhtml_tfoot_typeStruct) CommitPhaseOne(stage *models.Stage) (Error error) {

	var xhtml_tfoot_types []*models.Xhtml_tfoot_type
	for xhtml_tfoot_type := range stage.Xhtml_tfoot_types {
		xhtml_tfoot_types = append(xhtml_tfoot_types, xhtml_tfoot_type)
	}

	// Sort by the order stored in Map_Staged_Order.
	sort.Slice(xhtml_tfoot_types, func(i, j int) bool {
		return stage.Xhtml_tfoot_typeMap_Staged_Order[xhtml_tfoot_types[i]] < stage.Xhtml_tfoot_typeMap_Staged_Order[xhtml_tfoot_types[j]]
	})

	for _, xhtml_tfoot_type := range xhtml_tfoot_types {
