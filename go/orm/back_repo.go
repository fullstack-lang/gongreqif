...
type BackRepoStruct struct {
	...
	BackRepoTest BackRepoTestStruct
...
func NewBackRepo(stage *models.StageStruct, filename string) (backRepo *BackRepoStruct) {
	...
	// insertion point for per struct back repo declarations
	backRepo.BackRepoTest = BackRepoTestStruct{
		Map_TestDBID_TestPtr: make(map[uint]*models.Test, 0),
		Map_TestDBID_TestDB:  make(map[uint]*TestDB, 0),
		Map_TestPtr_TestDBID: make(map[*models.Test]uint, 0),
...
func (backRepo *BackRepoStruct) Commit(stage *models.StageStruct) {
	...
	backRepo.BackRepoTest.CommitPhaseOne(stage)

	// insertion point for per struct back repo phase two commit
	backRepo.BackRepoTest.CommitPhaseTwo(backRepo)
...
func (backRepo *BackRepoStruct) Checkout(stage *models.StageStruct) {
	// insertion point for per struct back repo phase one commit
	backRepo.BackRepoTest.CheckoutPhaseOne()

	// insertion point for per struct back repo phase two commit
	backRepo.BackRepoTest.CheckoutPhaseTwo(backRepo)
}
...
func (backRepo *BackRepoStruct) Backup(stage *models.StageStruct, dirPath string) {
	...
	backRepo.BackRepoTest.Backup(dirPath)
}
...
func (backRepo *BackRepoStruct) BackupXL(stage *models.StageStruct, dirPath string) {
	...
	// insertion point for per struct backup
	backRepo.BackRepoTest.BackupXL(file)
...
func (backRepo *BackRepoStruct) Restore(stage *models.StageStruct, dirPath string) {
	...
	// insertion point for per struct backup
	backRepo.BackRepoTest.RestorePhaseOne(dirPath)
	...
	// insertion point for per struct backup
	backRepo.BackRepoTest.RestorePhaseTwo()
...
func (backRepo *BackRepoStruct) RestoreXL(stage *models.StageStruct, dirPath string) {
	...
	// insertion point for per struct backup
	backRepo.BackRepoTest.RestoreXLPhaseOne(file)
