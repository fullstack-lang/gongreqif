...
func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) GetStage() (stage *models.Stage) {
	stage = backRepoSPEC_OBJECT_TYPE.stage
	return
}

func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) GetDB() db.DBInterface {
...
func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) CommitPhaseOne(stage *models.Stage) (Error error) {

	var spec_object_types []*models.SPEC_OBJECT_TYPE
	for spec_object_type := range stage.SPEC_OBJECT_TYPEs {
		spec_object_types = append(spec_object_types, spec_object_type)
	}

	// Sort by the order stored in Map_Staged_Order.
	sort.Slice(spec_object_types, func(i, j int) bool {
		return stage.SPEC_OBJECT_TYPEMap_Staged_Order[spec_object_types[i]] < stage.SPEC_OBJECT_TYPEMap_Staged_Order[spec_object_types[j]]
	})

	for _, spec_object_type := range spec_object_types {
...
func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) CommitDeleteInstance(id uint) (Error error) {
	...
	spec_object_typeDB := backRepoSPEC_OBJECT_TYPE.Map_SPEC_OBJECT_TYPEDBID_SPEC_OBJECT_TYPEDB[id]
	db, _ := backRepoSPEC_OBJECT_TYPE.db.Unscoped()
	_, err := db.Delete(spec_object_typeDB)
	if err != nil {
		log.Fatal(err)
	}
...
func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) CommitPhaseOneInstance(spec_object_type *models.SPEC_OBJECT_TYPE) (Error error) {
	...
	_, err := backRepoSPEC_OBJECT_TYPE.db.Create(&spec_object_typeDB)
	if err != nil {
		log.Fatal(err)
	}
...
func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) CommitPhaseTwoInstance(backRepo *BackRepoStruct, idx uint, spec_object_type *models.SPEC_OBJECT_TYPE) (Error error) {
	...
	if spec_object_typeDB, ok := backRepoSPEC_OBJECT_TYPE.Map_SPEC_OBJECT_TYPEDBID_SPEC_OBJECT_TYPEDB[idx]; ok {
		...
		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.ALTERNATIVE_ID.ALTERNATIVE_ID = make([]int, 0)
		// 2. encode
		for _, alternative_idAssocEnd := range spec_object_type.ALTERNATIVE_ID.ALTERNATIVE_ID {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.ALTERNATIVE_ID.ALTERNATIVE_ID =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.ALTERNATIVE_ID.ALTERNATIVE_ID, int(alternative_idAssocEnd_DB.ID))
		}

		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN = make([]int, 0)
		// 2. encode
		for _, attribute_definition_booleanAssocEnd := range spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN, int(attribute_definition_booleanAssocEnd_DB.ID))
		}

		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE = make([]int, 0)
		// 2. encode
		for _, attribute_definition_dateAssocEnd := range spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE, int(attribute_definition_dateAssocEnd_DB.ID))
		}

		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION = make([]int, 0)
		// 2. encode
		for _, attribute_definition_enumerationAssocEnd := range spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION, int(attribute_definition_enumerationAssocEnd_DB.ID))
		}

		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER = make([]int, 0)
		// 2. encode
		for _, attribute_definition_integerAssocEnd := range spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER, int(attribute_definition_integerAssocEnd_DB.ID))
		}

		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL = make([]int, 0)
		// 2. encode
		for _, attribute_definition_realAssocEnd := range spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL, int(attribute_definition_realAssocEnd_DB.ID))
		}

		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING = make([]int, 0)
		// 2. encode
		for _, attribute_definition_stringAssocEnd := range spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING, int(attribute_definition_stringAssocEnd_DB.ID))
		}

		// 1. reset
		spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML = make([]int, 0)
		// 2. encode
		for _, attribute_definition_xhtmlAssocEnd := range spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML {
			...
			spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML =
				append(spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML, int(attribute_definition_xhtmlAssocEnd_DB.ID))
		}

		_, err := backRepoSPEC_OBJECT_TYPE.db.Save(spec_object_typeDB)
		if err != nil {
			log.Fatal(err)
		}
...
func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) CheckoutPhaseOne() (Error error) {
	...
	_, err := backRepoSPEC_OBJECT_TYPE.db.Find(&spec_object_typeDBArray)
	if err != nil {
		return err
	}
...
func (spec_object_typeDB *SPEC_OBJECT_TYPEDB) DecodePointers(backRepo *BackRepoStruct, spec_object_type *models.SPEC_OBJECT_TYPE) {
	...
	// This loop redeem spec_object_type.ALTERNATIVE_ID.ALTERNATIVE_ID in the stage from the encode in the back repo
	// It parses all ALTERNATIVE_IDDB in the back repo and if the reverse pointer encoding matches the back repo ID
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.ALTERNATIVE_ID.ALTERNATIVE_ID = spec_object_type.ALTERNATIVE_ID.ALTERNATIVE_ID[:0]
	for _, _ALTERNATIVE_IDid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.ALTERNATIVE_ID.ALTERNATIVE_ID {
		spec_object_type.ALTERNATIVE_ID.ALTERNATIVE_ID = append(spec_object_type.ALTERNATIVE_ID.ALTERNATIVE_ID, backRepo.BackRepoALTERNATIVE_ID.Map_ALTERNATIVE_IDDBID_ALTERNATIVE_IDPtr[uint(_ALTERNATIVE_IDid)])
	}

	// This loop redeem spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN in the stage from the encode in the back repo
	...
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN = spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN[:0]
	for _, _ATTRIBUTE_DEFINITION_BOOLEANid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN {
		spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN = append(spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_BOOLEAN, backRepo.BackRepoATTRIBUTE_DEFINITION_BOOLEAN.Map_ATTRIBUTE_DEFINITION_BOOLEANDBID_ATTRIBUTE_DEFINITION_BOOLEANPtr[uint(_ATTRIBUTE_DEFINITION_BOOLEANid)])
	}

	// This loop redeem spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE in the stage from the encode in the back repo
	// It parses all ATTRIBUTE_DEFINITION_DATEDB in the back repo and if the reverse pointer encoding matches the back repo ID
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE = spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE[:0]
	for _, _ATTRIBUTE_DEFINITION_DATEid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE {
		spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE = append(spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_DATE, backRepo.BackRepoATTRIBUTE_DEFINITION_DATE.Map_ATTRIBUTE_DEFINITION_DATEDBID_ATTRIBUTE_DEFINITION_DATEPtr[uint(_ATTRIBUTE_DEFINITION_DATEid)])
	}

	// This loop redeem spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION in the stage from the encode in the back repo
	...
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION = spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION[:0]
	for _, _ATTRIBUTE_DEFINITION_ENUMERATIONid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION {
		spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION = append(spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_ENUMERATION, backRepo.BackRepoATTRIBUTE_DEFINITION_ENUMERATION.Map_ATTRIBUTE_DEFINITION_ENUMERATIONDBID_ATTRIBUTE_DEFINITION_ENUMERATIONPtr[uint(_ATTRIBUTE_DEFINITION_ENUMERATIONid)])
	}

	// This loop redeem spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER in the stage from the encode in the back repo
	...
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER = spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER[:0]
	for _, _ATTRIBUTE_DEFINITION_INTEGERid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER {
		spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER = append(spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_INTEGER, backRepo.BackRepoATTRIBUTE_DEFINITION_INTEGER.Map_ATTRIBUTE_DEFINITION_INTEGERDBID_ATTRIBUTE_DEFINITION_INTEGERPtr[uint(_ATTRIBUTE_DEFINITION_INTEGERid)])
	}

	// This loop redeem spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL in the stage from the encode in the back repo
	// It parses all ATTRIBUTE_DEFINITION_REALDB in the back repo and if the reverse pointer encoding matches the back repo ID
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL = spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL[:0]
	for _, _ATTRIBUTE_DEFINITION_REALid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL {
		spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL = append(spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_REAL, backRepo.BackRepoATTRIBUTE_DEFINITION_REAL.Map_ATTRIBUTE_DEFINITION_REALDBID_ATTRIBUTE_DEFINITION_REALPtr[uint(_ATTRIBUTE_DEFINITION_REALid)])
	}

	// This loop redeem spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING in the stage from the encode in the back repo
	...
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING = spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING[:0]
	for _, _ATTRIBUTE_DEFINITION_STRINGid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING {
		spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING = append(spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_STRING, backRepo.BackRepoATTRIBUTE_DEFINITION_STRING.Map_ATTRIBUTE_DEFINITION_STRINGDBID_ATTRIBUTE_DEFINITION_STRINGPtr[uint(_ATTRIBUTE_DEFINITION_STRINGid)])
	}

	// This loop redeem spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML in the stage from the encode in the back repo
	// It parses all ATTRIBUTE_DEFINITION_XHTMLDB in the back repo and if the reverse pointer encoding matches the back repo ID
	// it appends the stage instance
	// 1. reset the slice
	spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML = spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML[:0]
	for _, _ATTRIBUTE_DEFINITION_XHTMLid := range spec_object_typeDB.SPEC_OBJECT_TYPEPointersEncoding.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML {
		spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML = append(spec_object_type.SPEC_ATTRIBUTES.ATTRIBUTE_DEFINITION_XHTML, backRepo.BackRepoATTRIBUTE_DEFINITION_XHTML.Map_ATTRIBUTE_DEFINITION_XHTMLDBID_ATTRIBUTE_DEFINITION_XHTMLPtr[uint(_ATTRIBUTE_DEFINITION_XHTMLid)])
	}
...
func (backRepo *BackRepoStruct) CheckoutSPEC_OBJECT_TYPE(spec_object_type *models.SPEC_OBJECT_TYPE) {
	...
	if _, ok := backRepo.BackRepoSPEC_OBJECT_TYPE.Map_SPEC_OBJECT_TYPEPtr_SPEC_OBJECT_TYPEDBID[spec_object_type]; ok {
		...
		if id, ok := backRepo.BackRepoSPEC_OBJECT_TYPE.Map_SPEC_OBJECT_TYPEPtr_SPEC_OBJECT_TYPEDBID[spec_object_type]; ok {
			...
			if _, err := backRepo.BackRepoSPEC_OBJECT_TYPE.db.First(&spec_object_typeDB, id); err != nil {
...
func (backRepoSPEC_OBJECT_TYPE *BackRepoSPEC_OBJECT_TYPEStruct) RestorePhaseTwo() {
	...
	for _, spec_object_typeDB := range backRepoSPEC_OBJECT_TYPE.Map_SPEC_OBJECT_TYPEDBID_SPEC_OBJECT_TYPEDB {
		...
		db, _ := backRepoSPEC_OBJECT_TYPE.db.Model(spec_object_typeDB)
