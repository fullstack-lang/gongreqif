...
func fillUpTree(
	...
	for _, gongStruct := range sliceOfGongStructsSorted {
		...
		case "Test":
			...
			set := *models.GetGongstructInstancesSet[models.Test](probe.stageOfInterest)
			for _test := range set {
				nodeInstance := (&tree.Node{Name: _test.GetName()}).Stage(probe.treeStage)
				nodeInstance.IsNodeClickable = true
				nodeInstance.Impl = NewInstanceNodeCallback(_test, "Test", probe)
