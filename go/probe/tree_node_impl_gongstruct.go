...
func (nodeImplGongstruct *TreeNodeImplGongstruct) OnAfterUpdate(
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_BOOLEAN_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_BOOLEAN_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_DATE_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_DATE_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_ENUMERATION_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_ENUMERATION_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_INTEGER_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_INTEGER_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_REAL_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_REAL_Rendering](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_STRING_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_STRING_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ATTRIBUTE_DEFINITION_XHTML_Rendering" {
		updateProbeTable[*models.ATTRIBUTE_DEFINITION_XHTML_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "EmbeddedJpgImage" {
		updateProbeTable[*models.EmbeddedJpgImage](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "EmbeddedPngImage" {
		updateProbeTable[*models.EmbeddedPngImage](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "EmbeddedSvgImage" {
		updateProbeTable[*models.EmbeddedSvgImage](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "Map_identifier_bool" {
		updateProbeTable[*models.Map_identifier_bool](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "SPECIFICATION_Rendering" {
		updateProbeTable[*models.SPECIFICATION_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "SPEC_OBJECT_TYPE_Rendering" {
		updateProbeTable[*models.SPEC_OBJECT_TYPE_Rendering](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "StaticWebSite" {
		updateProbeTable[*models.StaticWebSite](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "StaticWebSiteChapter" {
		updateProbeTable[*models.StaticWebSiteChapter](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "StaticWebSiteGeneratedImage" {
		updateProbeTable[*models.StaticWebSiteGeneratedImage](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "StaticWebSiteImage" {
		updateProbeTable[*models.StaticWebSiteImage](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "StaticWebSiteParagraph" {
		updateProbeTable[*models.StaticWebSiteParagraph](nodeImplGongstruct.probe)
	}
