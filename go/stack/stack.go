...
import (
	...
	"github.com/fullstack-lang/gongreqif/go/fullstack"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongreqif/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongreqif_go.GoModelsDir, gongreqif_go.GoDiagramsDir,
