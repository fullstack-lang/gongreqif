...
import (
	...
	"github.com/fullstack-lang/gongreqif"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongreqif.NgDistNg, "ng-github.com-fullstack-lang-gongreqif/dist/ng-github.com-fullstack-lang-gongreqif/browser")))
