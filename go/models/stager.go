...
type Stager struct {
	...
	Map_ATTRIBUTE_DEFINITION_XHTML_ShowIdentifier       map[*ATTRIBUTE_DEFINITION_XHTML]bool
	Map_ATTRIBUTE_DEFINITION_STRING_ShowIdentifier      map[*ATTRIBUTE_DEFINITION_STRING]bool
	Map_ATTRIBUTE_DEFINITION_BOOLEAN_ShowIdentifier     map[*ATTRIBUTE_DEFINITION_BOOLEAN]bool
	Map_ATTRIBUTE_DEFINITION_INTEGER_ShowIdentifier     map[*ATTRIBUTE_DEFINITION_INTEGER]bool
	Map_ATTRIBUTE_DEFINITION_DATE_ShowIdentifier        map[*ATTRIBUTE_DEFINITION_DATE]bool
	Map_ATTRIBUTE_DEFINITION_REAL_ShowIdentifier        map[*ATTRIBUTE_DEFINITION_REAL]bool
	Map_ATTRIBUTE_DEFINITION_ENUMERATION_ShowIdentifier map[*ATTRIBUTE_DEFINITION_ENUMERATION]bool
